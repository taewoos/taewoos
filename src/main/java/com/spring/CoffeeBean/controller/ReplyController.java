...
import com.spring.CoffeeBean.reply.service.IReplyService;
...
public class ReplyController {
	...
	//페이징이 추가된 댓글 목록
	@GetMapping("/getList/{boardNo}/{pageNum}")
	public Map<String, Object> getList(@PathVariable int boardNo, @PathVariable int pageNum) {
		...
		List<ReplyVO> list = service.getList(vo, boardNo); //댓글 목록 데이터
		int total = service.getTotal(boardNo); //전체 댓글 개수
