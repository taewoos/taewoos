	...
	<form action="<c:url value='/freeboard/freeUpdate'/>" method="post" name="updateForm">
		<div class="board_write_wrap">
			<div class="board_write board_modify">
				<div class="form-group">
					<div class="info">
						<dl>
							...
							<dd>
								<input class="form-control" name='boardNo' value="${article.boardNo}" readonly>
							</dd>
						</dl>
				...
				<div class="form-group">
					<div class="title">
						<dl>
							...
							<dd>
								<input class="form-control input-sm" name="boardTitle" value="${article.boardTitle}">
							</dd>
						</dl>
					</div>
				</div>
				<div class="form-group">
					<div class="cont">
						<textarea class="form-control" rows="10" name="boardContent">${article.boardContent}</textarea>
					</div>
				</div>
			</div>
