    ...
    <div class="contents">
        ...
        <div class="row my_Information">
            <div class="col-md-4" id="a">
                <h2 class="myUser_h2"><strong>${login.userId}</strong>  <br>  환영합니다.</h2>
                <a href="#">
               <button type="button" class="btn btn-modify" onclick="location.href='${pageContext.request.contextPath}/user/userInfoModify'">기업정보수정</button>
            </a>
            </div>


            <div class="col-md-4" id="b">
                <h2>등록 공고수 <br>    <span class="resume_count" > ${RecCount} </span> 개 </h2>
                <a href="#">
               <button type="button" class="btn btn-modify" onclick="location.href='${pageContext.request.contextPath}/mypage/chlist'">공고 관리</button>
            </a>
            </div>
            ...
            <div class="col-md-4" id="c">
                ...
                <a href="#">
               <button type="button" class="btn btn-modify" data-toggle="modal" data-target="#messageModal">쪽지함</button>
            </a>
            </div>
        ...
        <div class="row my_list_wrap">
            ...
            <table class="table table-hover col-md-8" id="g">
                <thead>
                    <tr>
                        <th class="col-md-3">지원자 이름</th>
                        <th class="col-md-3">공고 제목</th>
                        <th class="col-md-3">진행단계</th>                       
            ...
            <c:forEach var="vo" items="${article}">
                    ...
                    <tr>                                           
                        <td> <a href='<c:url value="/resume/resumeComCheck/${vo.resNo}" />'/> <c:out value="${vo.resName}"/> </a> </td>
                          <td>
                    <a class="move" href='/recruitment/view/<c:out value="${vo.recNo}"/>'>
                        <c:out value="${vo.boardTitle}"/>
                    </a>
                </td> 
                        <td>                         <c:set var="reqPreg" value="${vo.reqPreg}" />
                        <c:choose>
                    ...
                    <c:when test="${reqPreg eq 3}">
                        ...
                                  불합격  
                         ...
                         <td><fmt:formatDate pattern="yyyy-MM-dd" value="${vo.boardDate}"/></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
