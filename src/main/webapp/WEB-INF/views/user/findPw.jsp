...
<body>
	...
	<section >
		...
		<form action="${pageContext.request.contextPath}/user/findPwResult" method="post" id="findPwForm">	
			...
			<div class="findBtn">
			  <button class="btn btn-info findBtn" type="button" id="findPwBtn">확인</button>
			</div>	
		</form>
	</section>
